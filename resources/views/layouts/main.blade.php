...
<body data-topbar="colored">
    ...
    <script>
        ...
        function showEditForm(id, modul, soal, pembahasan, no, j1, j2, j3, j4, j5) {
            ...
            // Scroll ke atas otomatis agar langsung kelihatan formnya
    ...
    <div id="loading-overlay">
        ...
        <h4 class="text-white">Harap tunggu, sedang memproses data...</h4>
        <p>Proses ini mungkin memakan waktu beberapa saat tergantung ukuran file.</p>
    </div>

    <script>
        // Global function to show/hide loading
        function showLoading(message = null) {
            if (message) {
                $('#loading-overlay h4').text(message);
            }
        ...
        setInterval(function() {
            fetch('/ping').then(response => {
                if (response.status === 419) {
                    window.location.reload(); // Reload to show the custom 419 page
                }
