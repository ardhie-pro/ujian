...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Shared By NULLPHPSCRIPT.COM - Form Editors | Agroxa - Responsive Bootstrap 5 Admin Dashboard</title>
    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('assetts/images/logo-sm-dark.png') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
            ...
            <div class="vertical-menu">
                ...
                <div data-simplebar class="h-100">
                    <div class="user-details">
                        <div class="d-flex">
                            <div class="me-2">
                                <img src="{{ asset('assetts/images/users/avatar-4.jpg') }}" alt="" class="avatar-md rounded-circle">
                            </div>
        ...
        <div class="right-bar">
            <div data-simplebar class="h-100">
                ...
                <div class="p-4">
                    <div class="mb-2">
                        <img src="{{ asset('assetts/images/layouts/layout-1.png') }}" class="img-fluid img-thumbnail" alt="">
                    </div>
                    ...
                    <div class="mb-2">
                        <img src="{{ asset('assetts/images/layouts/layout-2.png') }}" class="img-fluid img-thumbnail" alt="">
                    </div>

                    <div class="form-check form-switch mb-3">
                        <input type="checkbox" class="form-check-input theme-choice" id="dark-mode-switch"
                            data-bsStyle="assetts/css/bootstrap-dark.min.css" data-appStyle="assetts/css/app-dark.min.css" />
                        <label class="form-check-label" for="dark-mode-switch">Dark Mode</label>
                    </div>

                    <div class="mb-2">
                        <img src="{{ asset('assetts/images/layouts/layout-3.png') }}" class="img-fluid img-thumbnail" alt="">
                    </div>
                    <div class="form-check form-switch mb-5">
                        <input type="checkbox" class="form-check-input theme-choice" id="rtl-mode-switch"
                            data-appStyle="assetts/css/app-rtl.min.css" />
