    ...
    <style>
        ...
        * {
        ...
        .eye-toggle {
            position: absolute;
            right: 18px;
            top: 45px; /* Adjusted for label height */
            cursor: pointer;
        ...
        <div class="login-section">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="input-group">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="user@domain.com" class="{{ $errors->has('email') ? 'is-invalid' : '' }}" required autofocus>
                </div>
